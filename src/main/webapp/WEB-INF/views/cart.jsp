...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#all").click(function () {
                $("input[name='carId']").prop("checked",$(this).prop("checked"));
                var prices = 0;
                    ...
                    <div class="col-md-8">
                        <table class="table shop-cart">
                            ...
                            <tr class="cart_item">
                                ...
                                <td>
                                    <input type="checkbox" name="carId" value="${product.carId}"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="5" class="actions">
                                    ...
                                    <input type="submit" class="update-cart" name="update_cart" value="更新购物车" />
                                </td>
                    ...
                    <div class="col-md-4">
                        <div class="cart-totals">
                            ...
                            <div class="proceed-to-checkout">
                                <a href="javascript:void (0);" onclick="pay()">进行结算</a>
                            </div>
                        </div>
