...
<script type="text/javascript" src="${path}/static/js/core.min.js"></script>
<script type="text/javascript" src="${path}/static/js/widget.min.js"></script>
<script type="text/javascript" src="${path}/static/js/mouse.min.js"></script>
<script type="text/javascript" src="${path}/static/js/slider.min.js"></script>
<script type="text/javascript" src="${path}/static/js/jquery.ui.touch-punch.js"></script>
<script type="text/javascript" src="${path}/static/js/price-slider.js"></script>
</body>
</html>
